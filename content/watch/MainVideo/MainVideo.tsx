...
const MainVideo = () => {
  ...
  return (
    <div className="w-full bg-dark-card rounded-md p-2 !pb-0 flex flex-col">
      <iframe
        src={watchInfo?.url}
      ...
      <div className="h-full min-h-[124px] bg-jade-800 text-slate-100 flex rounded-md overflow-hidden mt-4 shadow-[3px_13px_29px_0px_#065f4680] max-[880px]:flex-col">
